...
from datasets import get_dataset, FinetuneDataset, ISICDataset
...
def main(args):
    ...
    args.log_dir = os.path.join(args.log_dir, 'in-progress_' + args.name + dt)
    ...
    dataset = ISICDataset(data_dir=args.val_dir, transform=get_aug(args.aug, train=False))
